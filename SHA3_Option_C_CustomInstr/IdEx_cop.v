module IdEx(
    ...
    input wire [17:0] id_control_sig,
    output reg [17:0] ex_control_sig,
    ...
    always @(posedge clk or posedge rst) begin
        if (rst || flush) begin
            ex_control_sig <= 18'b0;
            ex_pc <= 32'b0; ex_imm <= 32'b0; ex_dat1 <= 32'b0; ex_dat2 <= 32'b0;
            ex_rs1 <= 5'b0; ex_rs2 <= 5'b0; ex_rd <= 5'b0;
        end else begin
            ex_control_sig <= id_control_sig;
            ex_pc <= id_pc; ex_imm <= id_imm; ex_dat1 <= id_dat1; ex_dat2 <= id_dat2;
